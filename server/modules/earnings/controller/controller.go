// Package controller expoe /api/earnings.
//
// Nao usa shared/crud porque o GET aceita ?month e toda mutacao mexe no saldo
// da conta vinculada.
package controller
...
import (
	...
	"financaspro/server/modules/earnings/validation"
...
func (c *Controller) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err := c.repo.Update(r.Context(), id, middleware.UserID(r.Context()), body); err != nil {
		responses.Error(w, r, c.log, err)
		return
	}
	responses.OK(w)
